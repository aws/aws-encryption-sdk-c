 ...
 * raw data into hdr->edk_list. Raises AWS_CRYPTOSDK_ERR_LIMIT_EXCEEDED if the
 * EDK count is greater than max_encrypted_data_keys (and
 * max_encrypted_data_keys is nonzero).
 */
