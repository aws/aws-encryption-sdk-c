 ...
 */
static inline int t_assert_edk_contains_expected_values(
 ...
 */
static inline int t_assert_edks_with_single_element_contains_expected_values(
 ...
 */
static inline int t_assert_edks_equals(
    const struct aws_array_list *encrypted_data_keys_a, const struct aws_array_list *encrypted_data_keys_b) {
 ...
 */
static inline int t_append_c_str_key_to_edks(
    struct aws_allocator *allocator,
    struct aws_array_list *encrypted_data_keys,
    ...
    return append_key_dup_to_edks(allocator, encrypted_data_keys, enc_data_key, &data_key_id_str, &key_provider_bb);
}
