...
static struct aws_cryptosdk_edk build_edk(const uint8_t * edk_bytes, size_t edk_len, const uint8_t * iv) {
        ...
        int ret = aws_byte_buf_init(alloc, &edk.provider_info, sizeof(edk_provider_prefix) - 1 + RAW_AES_MK_IV_LEN);
