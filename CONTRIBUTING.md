...
Please run clang-format 6.0 before sending in a PR. The `reformat.sh` script
can be used to automatically reformat most of the code in the repository on
Linux or other unix-linux platforms, as long as you have clang-format 6.0
installed.
