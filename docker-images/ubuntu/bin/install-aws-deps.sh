...
for libtype in shared static; do
    ...
    # TODO: source this version number from a central place
    build_pkg $root/install https://github.com/aws/aws-sdk-cpp.git 1.7.231 $CMAKE_ARGS -DBUILD_ONLY=kms -DENABLE_UNITY_BUILD=ON
done
